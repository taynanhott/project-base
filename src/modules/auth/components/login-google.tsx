...
export default function LoginGoogleForm({ loginGoogle }: LoginGoogleFormProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-3">
      <Button type="button" onClick={signInWithGoogle} className="flex w-full justify-center rounded-md border border-muted px-3 py-2 text-sm font-semibold text-muted-foreground shadow-sm hover:bg-muted hover:text-muted-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
